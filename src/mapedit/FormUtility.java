...
public class FormUtility {
	...
	private GridBagConstraints topConstraints = null;
	private GridBagConstraints multiConstraints = null;
	...
	public FormUtility() {
		...
		// lastConstraints.anchor = GridBagConstraints.NORTH;
		...
		topConstraints = (GridBagConstraints) lastConstraints.clone();
		topConstraints.weighty = 1;
		topConstraints.anchor = GridBagConstraints.NORTH;
		
		multiConstraints = (GridBagConstraints) labelConstraints.clone();
		multiConstraints.gridwidth = 1;
	}
	
	/** Adds a field component. Any component may be used. The component will be stretched to take the remainder of the current row. */
	...
	/** Adds an arbitrary label component, starting a new row if appropriate. The width of the component will be set to the minimum width of the widest component
	 * on the form. */
	...
	public void addLabel2(Component c, Container parent) {
		GridBagLayout gbl = (GridBagLayout) parent.getLayout();
		gbl.setConstraints(c, topConstraints);
		parent.add(c);
	}
	
	public void addLabel3(Component c, Container parent) {
		GridBagLayout gbl = (GridBagLayout) parent.getLayout();
		gbl.setConstraints(c, multiConstraints);
		parent.add(c);
	}
	
	/** Adds a "middle" field component. Any component may be used. The component will be stretched to take all of the space between the label and the "last"
